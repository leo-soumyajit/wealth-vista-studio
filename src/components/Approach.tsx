      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-card p-8 rounded-2xl border border-border hover:border-primary/50 transition-all duration-300 h-full hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-2">
                {/* Step Number */}
                <div className="absolute -top-4 -left-4 w-10 h-10 bg-primary rounded-full flex items-center justify-center font-bold text-primary-foreground shadow-lg">
                  {index + 1}
                </div>
        ...
        <div className="mt-16 bg-card p-8 rounded-2xl border border-border">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-secondary/50 px-4 py-2 rounded-full text-sm">
